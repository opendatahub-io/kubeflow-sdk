...
try:
    ...
    raise RuntimeError(
        ...
        f"Client SDK: {client_sdk_version}, Runtime SDK: < 1.5.0 or missing\\n"
        f"Update the runtime image to SDK >= 1.5.0."
    ) from e
...
try:
    ...
    raise RuntimeError(
        ...
        f"Error: {{e}}\\n"
        f"Update runtime image to SDK version {{CLIENT_SDK_VERSION}}."
    ) from e
except Exception as e:
    raise RuntimeError(
